<?php
  ...
  #define('_SESSION_PATH_', _ADMIN_PATH_ . 'ses_b7e54b49db526100798d8672a557588d' . $path_separator);
  ...
  $dbn    = 'pom';    # dev database name/prefix
  $dbu    = 'root';       # dev database username
  $dbp    = 'vertrigo';  # dev database password
